...
class Envs:
    ...
    SGLANG_HUMMING_FUSED_MASKED_ACT_QUANT = EnvBool(True)
    SGLANG_HUMMING_ENABLE_SBO = EnvBool(False)
    SGLANG_HUMMING_DISABLE_DOWN_GEMM_OVERLAP = EnvBool(False)
    ...
    # Optional comma-separated M256-aligned upper bounds for measured prefill
    # shapes. When set, these bounds take precedence over power-of-two buckets.
    SGLANG_OPT_MOK_PREFILL_BUCKETS = EnvTuple(())
