...
class Envs:
    ...
    # Diagnostic only: run DeepGEMM beside the selected MoK GEMM once per
    # layer/stage and log elementwise output deltas. Never enable for perf.
    SGLANG_OPT_MOK_FP8_NUMERIC_AUDIT = EnvBool(False)
