...
from sglang.srt.utils.common import get_device_sm, is_sm90_supported, is_sm120_supported
...
class Mxfp4MarlinMoEMethod:
    ...
    def process_weights_after_loading(self, layer: Module) -> None:
        ...
        # Ada uses the same W4A16 Marlin path; the caller explicitly selects
        # the marlin runner and the layer shape gate below still applies.
        if (
            get_device_sm() != 89
