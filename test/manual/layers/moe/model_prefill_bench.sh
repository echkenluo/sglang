...
case "$MODE" in
  ...
  mok-fused) ENV_MODE="SGLANG_OPT_USE_MOK_FP8_NATIVE=1 SGLANG_OPT_MOK_FP8_NATIVE_STRICT=1 SGLANG_OPT_MOK_FP8_NATIVE_PREFILL_GRAPH=1 SGLANG_OPT_MOK_FP8_NATIVE_FUSED_DISPATCH_GEMM=1" ;;
  deepep) ENV_MODE="" ;;
